...
/// </summary>
public class AuditLogRepository : GenericRepository<AuditLog, CoreDbContext>, IAuditLogRepository
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AuditLogRepository"/> class.
    /// </summary>
    /// <param name="context">The database context.</param>
    public AuditLogRepository(CoreDbContext context) : base(context)
    {
    }
